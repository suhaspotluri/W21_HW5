############################################## Name:Suhas Potluri########## Uniqname:spotlu##############################################
import unittest
import hw5_cards
...
class TestCard(unittest.TestCase):
    ...
    def test_q3(self):
        ...
        self.assertEqual(str(c1), "King of Spades")
        '''
    ...
    def test_q5(self):
        d1=hw5_cards.Deck()
        x=d1.deal_card()
        self.assertIsInstance(x,hw5_cards.Card)
        '''
